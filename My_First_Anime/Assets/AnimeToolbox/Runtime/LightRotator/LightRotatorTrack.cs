...
[TrackColor(0.01401742f, 0.990566f, 0.05742574f)]
[TrackClipType(typeof(LightRotatorClip))]
[TrackBindingType(typeof(Transform))]
public class LightRotatorTrack : TrackAsset
{
    public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
    {
        return ScriptPlayable<LightRotatorMixerBehaviour>.Create (graph, inputCount);
    }
    ...
    public override void GatherProperties (PlayableDirector director, IPropertyCollector driver)
    {
        ...
        //driver.AddFromName<Transform>(trackBinding.gameObject, "m_EulerAngles");
